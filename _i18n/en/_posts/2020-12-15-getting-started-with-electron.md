...
Of course, as I said before, if I want to keep my app secure I can't use directly it from renderer process. There is a final step to implement called _preloading_.
...
Many of well known and widely used desktop application are developed with Electron and work pretty well such as
- Slack
- Discord
- Notion
- VSCode
